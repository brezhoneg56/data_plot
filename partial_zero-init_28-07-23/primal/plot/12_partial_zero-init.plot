...
set xlabel 'Sweep [-]'
set ylabel 'Dissipated Energy du to Pressure Drop [Nm]'
...
set output '../eps/12_primal_zero-init_partial.eps'

plot '../../1_intervals_26-07-23_zero-init/logtable1.csv' using 1:2 with linespoints title '1 interval' , \
