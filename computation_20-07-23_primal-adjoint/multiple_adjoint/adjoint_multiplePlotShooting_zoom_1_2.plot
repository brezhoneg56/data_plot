...
plot '../1_intervals_20-07_primal-adjoint/adjoint/adjointlogtable1.csv' using 1:2 with linespoints title '1 intervals' , \
...
set output 'plot_adjoint_1_2_Comparison_intervals.png'
replot

# Set up SVG terminal
set terminal svg size 800,600 fname 'Verdana' enhanced
set output 'plot_adjoint_1_2_Comparison_intervals.svg'
