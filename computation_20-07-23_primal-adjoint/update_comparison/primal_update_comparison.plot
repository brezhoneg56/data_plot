...
# Define blue and red line styles
set style line 1 lc rgb 'blue' lt 1 lw 2 pt 7 pi -1 ps 0.9
set style line 2 lc rgb 'red' lt 1 lw 2 pt 5 pi -1 ps 0.9
...
set output 'plot_1_2_update_Comparison.eps'

plot '../1_intervals_20-07_primal-adjoint/logtable1.csv' using 1:2 with linespoints linecolor rgb '#00FF00' title '2 intervals' , \
'../2_intervals_20-07_primal-adjoint/logtable2.csv' using 1:2 with linespoints linecolor rgb '#00FF00' title '2 intervals' , \
'../3_intervals_20-07_primal-adjoint/logtable3.csv' using 1:2 with linespoints linecolor rgb '#00FF00' title '3 intervals' , \
'../5_intervals_20-07_primal-adjoint/logtable5.csv' using 1:2 with linespoints linecolor rgb '#00FF00' title '5 intervals' , \
...
set output 'plot_1_2_update_Comparison.png'
replot
