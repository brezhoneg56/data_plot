...
set output '../eps/62_primal_modef_partial_zoom.eps'

plot '../../1_intervals_05-06-23/logtable1.csv' using 6:2 with linespoints title '1 interval' , \
...
set output '../pdf/62_primal_modef_partial_zoom.pdf'
replot
