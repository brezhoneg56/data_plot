...
set output '../eps/12_adjoint_modef_partial.eps'

plot '../adjointlogtable1.csv' using 1:2 with linespoints title '1 interval' , \
'../adjointlogtable2.csv' using 1:2 with linespoints title '2 intervals' , \
'../adjointlogtable3.csv' using 1:2 with linespoints title '3 intervals' , \
'../adjointlogtable5.csv' using 1:2 with linespoints title '5 intervals' , \
'../adjointlogtable7.csv' using 1:2 with linespoints title '7 intervals' , \
