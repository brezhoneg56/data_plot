...
set output '../eps/14_primal_modef_newton.eps'

plot '../../1_intervals_20-07_primal-adjoint/logtable1.csv' using 1:4 with linespoints title '1 interval' , \
'../../2_intervals_20-07_primal-adjoint/logtable2.csv' using 1:4 with linespoints title '2 intervals' , \
'../../3_intervals_20-07_primal-adjoint/logtable3.csv' using 1:4 with linespoints title '3 intervals' , \
'../../5_intervals_20-07_primal-adjoint/logtable5.csv' using 1:4 with linespoints title '5 intervals' , \
'../../7_intervals_20-07_primal-adjoint/logtable7.csv' using 1:4 with linespoints title '7 intervals' , \
...
set output '../pdf/14_primal_modef_newton.pdf'
replot
